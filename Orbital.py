...
def mkplot(dvDep, dvArr, tls, als, deltaVcutoff):
...
@xw.func
def porkchop(m, m1, m2, a1, a2, r1, r2, hlo, tmin, tmax, dAng, dT, deltaVcutoff):
    mu = m * G
    mu1 = m1 * G
    mu2 = m2 * G
    dvDep, dvArr, tls, als = scan(
        mu, mu1, mu2, a1, a2, r1, r2, hlo, tmin, tmax, dAng, dT
    )

    mkplot(dvDep, dvArr, tls, als, deltaVcutoff)
